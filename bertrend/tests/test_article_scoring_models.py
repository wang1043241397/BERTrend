...
class TestArticleScore:
    ...
    def test_article_score_creation(self):
        ...
        assert article_score.assessment_summary == "Good analysis with some unique insights"
    ...
    def test_quality_level_determination(self):
        ...
        poor_scores = CriteriaScores(**{name: 0.1 for name in CriteriaScores.get_criterion_names()})
        poor_article = ArticleScore(
            scores=poor_scores, weights=weights
        )
        ...
        excellent_scores = CriteriaScores(**{name: 1.0 for name in CriteriaScores.get_criterion_names()})
        excellent_article = ArticleScore(
            scores=excellent_scores, weights=weights
        )
        ...
        assert excellent_article.quality_level in [QualityLevel.POOR, QualityLevel.FAIR, QualityLevel.AVERAGE, QualityLevel.GOOD, QualityLevel.EXCELLENT]
    ...
    def test_to_report(self):
        ...
        article_score = ArticleScore(
            scores=scores,
            weights=weights,
            assessment_summary="Good analysis provided"
        )
        ...
        assert "Poor" in report_with_breakdown or "Fair" in report_with_breakdown or "Average" in report_with_breakdown or "Good" in report_with_breakdown or "Excellent" in report_with_breakdown
