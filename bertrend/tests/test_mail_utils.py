...
class TestGetCredentials:
    ...
    def test_expired_credentials_refresh(self, mock_request_class, mock_token_path, mock_credentials_class):
    ...
    def test_no_valid_credentials_flow(self, mock_flow_class, mock_token_path, mock_credentials_class):
    ...
    @patch('bertrend_apps.common.mail_utils.Credentials')
    @patch('bertrend_apps.common.mail_utils.TOKEN_PATH')
    def test_invalid_credentials_no_refresh_token(self, mock_token_path, mock_credentials_class):
        ...
        with patch('bertrend_apps.common.mail_utils.InstalledAppFlow') as mock_flow_class:
            mock_flow = Mock()
            mock_new_creds = Mock()
...
class TestSendEmail:
    ...
    def test_send_email_with_custom_filename(self, mock_mimetypes, mock_build):
        ...
        try:
            # Test
            send_email(credentials, subject, recipients, file_path, file_name=custom_filename)
    ...
    def test_send_email_unexpected_error(self, mock_logger, mock_build):
        ...
        # Assertions
        mock_logger.exception.assert_called_once_with("Unexpected error: ", unexpected_error)
    ...
    def test_send_email_unknown_mime_type(self, mock_mimetypes, mock_build):
        ...
        with tempfile.NamedTemporaryFile(mode='wb', suffix='.unknown', delete=False) as tmp_file:
...
class TestIntegration:
    ...
    @patch('bertrend_apps.common.mail_utils.Credentials')
    @patch('bertrend_apps.common.mail_utils.TOKEN_PATH')
    def test_full_email_workflow(self, mock_token_path, mock_credentials_class, mock_build):
